        ...
        <Modal title="Settings" onClose={onClose} width="lg">
            <div className="space-y-5 sm:space-y-6">
                ...
                <div className="border-b border-zinc-700 pb-1">
                    <h3 className="text-sm font-semibold text-zinc-200">Logging</h3>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            className="w-20 px-3 py-2.5 sm:py-2 bg-zinc-700 border border-zinc-600 rounded text-sm"
                            min={1}
                            max={100}
                            step={1}
                        />
                ...
                <div className="border-b border-zinc-700 pb-1 mt-2">
                    <h3 className="text-sm font-semibold text-zinc-200">Vehicle</h3>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            className="flex-1 px-3 py-2.5 sm:py-2 bg-zinc-700 border border-zinc-600 rounded text-sm"
                            min={500}
                            max={5000}
                            step={10}
                        />
                        <span className="text-sm text-zinc-400 w-8">kg</span>
                    </div>
                    <p className="text-xs text-zinc-500 mt-1">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2">
                        <input
                            ...
                            className="w-16 sm:w-20 px-2 py-2.5 sm:py-2 bg-zinc-700 border border-zinc-600 rounded text-sm text-center"
                            min={135}
                            max={355}
                            step={5}
                        />
                        ...
                        <input
                            ...
                            className="w-14 sm:w-16 px-2 py-2.5 sm:py-2 bg-zinc-700 border border-zinc-600 rounded text-sm text-center"
                            min={20}
                            max={80}
                            step={5}
                        />
                ...
                <div>
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                        ...
                        <label className="flex items-center gap-2 text-xs cursor-pointer select-none">
                            <input
                                ...
                                className="w-4 h-4 sm:w-3.5 sm:h-3.5 rounded bg-zinc-700 border-zinc-600"
                            />
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            step={1}
                        />
                        <span className="text-sm text-zinc-400 w-8">mm</span>
                    </div>
                ...
                {/* Drivetrain Section */}
                <div className="border-b border-zinc-700 pb-1 mt-2">
                    <h3 className="text-sm font-semibold text-zinc-200">Drivetrain</h3>
                </div>
                    ...
                    <div className="grid grid-cols-4 sm:grid-cols-7 gap-2">
                        {[1, 2, 3, 4, 5, 6, 7].map((gear) => (
                            <div key={gear} className="flex flex-col items-center">
                                <span className="text-xs text-zinc-500 mb-1">Gear {gear}</span>
                                <input
                                    type="number"
                                    ...
                                    className="w-full px-2 py-2 sm:py-1.5 bg-zinc-700 border border-zinc-600 rounded text-sm text-center"
                                    min={0}
                                    max={10}
                                    step={0.01}
                                />
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            className="w-24 px-3 py-2.5 sm:py-2 bg-zinc-700 border border-zinc-600 rounded text-sm"
                            min={1}
                            max={6}
                            step={0.01}
                        />
                ...
                {/* Info Box */}
                <div className="p-3 bg-zinc-900 rounded border border-zinc-700 text-xs text-zinc-400">
                    <p className="font-medium text-zinc-300 mb-1">Dyno Light Calculation</p>
