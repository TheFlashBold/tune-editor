        ...
        <Modal title="Select Definition" onClose={onClose} width="lg">
            <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            {matches.map(({entry, mode}) => (
                                <button
                                    ...
                                    className="w-full text-left p-3 bg-zinc-700 hover:bg-zinc-600 rounded border border-zinc-600 transition-colors"
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-xs px-2 py-1 rounded bg-green-900 text-green-300">
                ...
                {allDefinitions.length > 0 && (
                    <div>
                        <h3 className="text-sm font-semibold text-zinc-400 mb-2 mt-4">
                        ...
                        <div className="max-h-60 overflow-y-auto space-y-1">
                            {allDefinitions.map((entry) => (
                                ...
                                >
                                    ...
                                    <span className="text-zinc-500 ml-2">({entry.paramCount})</span>
                                </button>
                            ))}
                        </div>
                    </div>
